...
ALLOWED_ORIGINS = os.getenv(
    "ALLOWED_ORIGINS", 
    "http://localhost:3000,https://ai-dashboard-frontend-new-527790332290.europe-west1.run.app"
).split(",")
...
app.add_middleware(
    ...
    allow_methods=["*"],  # غيرت من GET, POST, PUT, DELETE لـ *
    allow_headers=["*"],  # غيرت من Authorization, Content-Type لـ *
    expose_headers=["*"]  # ضفت السطر ده
)
